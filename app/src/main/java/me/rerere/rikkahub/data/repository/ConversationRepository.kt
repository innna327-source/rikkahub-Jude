...
class ConversationRepository(
    ...
    fun conversationToConversationEntity(conversation: Conversation): ConversationEntity {
        ...
        return ConversationEntity(
            ...
            autoCompressConfig = conversation.autoCompressConfig?.let(JsonInstant::encodeToString) ?: "",
        )
    }
    ...
    fun conversationEntityToConversation(
        ...
        return Conversation(
            ...
            compressedMessageNodeIds = JsonInstant.decodeFromString(conversationEntity.compressedMessageNodeIds),
            autoCompressConfig = conversationEntity.autoCompressConfig
