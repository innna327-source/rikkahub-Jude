...
class RikkaHubApp : Application() {
    ...
    private fun startUsageReminderIfEnabled() {
        get<AppScope>().launch {
            runCatching {
                ...
                Log.e(TAG, "startUsageReminderIfEnabled failed", it)
            }
        }
    }
    ...
    private fun createNotificationChannel() {
        ...
        val usageReminderMonitorChannel = NotificationChannelCompat
            ...
            .setShowBadge(false)
            .build()
        notificationManager.createNotificationChannel(usageReminderMonitorChannel)

        val usageLimitReminderChannel = NotificationChannelCompat
            .Builder(USAGE_LIMIT_REMINDER_CHANNEL_ID, NotificationManagerCompat.IMPORTANCE_HIGH)
            .setName(getString(R.string.notification_channel_usage_limit_reminder))
            .setVibrationEnabled(true)
            .build()
        notificationManager.createNotificationChannel(usageLimitReminderChannel)
    }
