        ...
        LazyColumn(
            ...
            item {
                CardGroup(
                    ...
                    item(
                        headlineContent = { Text(stringResource(R.string.setting_display_page_paragraph_tts_title)) },
                        supportingContent = { Text(stringResource(R.string.setting_display_page_paragraph_tts_desc)) },
                        trailingContent = {
                            Switch(
                                checked = displaySetting.showParagraphTtsButtons,
                                onCheckedChange = {
                                    updateDisplaySetting(displaySetting.copy(showParagraphTtsButtons = it))
                                }
                            )
                        },
                    )
