        ...
        LazyColumn(
            ...
            item("localFeatures") {
                CardGroup(
                    ...
                    item(
                        onClick = { navController.navigate(Screen.UsageTracker) },
                        leadingContent = { Icon(HugeIcons.Database02, null) },
                    ...
                    item(
                        onClick = { navController.navigate(Screen.Weather) },
                        leadingContent = { Icon(HugeIcons.Cloud, null) },
                        supportingContent = { Text(stringResource(R.string.setting_page_weather_mcp_desc)) },
                        headlineContent = { Text(stringResource(R.string.setting_page_weather_mcp)) },
                    )
                }
            }
